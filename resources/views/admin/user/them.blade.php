                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/user/them" method="POST">
                            ...
                            <div class="form-group">
                                <label>Họ tên</label>
                                <input class="form-control" name="txtName" placeholder="Nhập tên người dùng" />
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input class="form-control" type="password" name="txtPasswordAgain" placeholder="Nhập lại mật khẩu" />
                            </div>
                            <div class="form-group">
